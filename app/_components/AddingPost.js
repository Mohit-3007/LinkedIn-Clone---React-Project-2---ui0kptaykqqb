...
// getting the first leter of UserName
    ...
    return (
        <div  className='w-full h-[592px] z-30 bg-[#666666] bg-opacity-70 fixed top-[30px] flex items-center justify-center'>
            <div ref={ref} className='w-full res-748:w-[744px] h-full dark:bg-[rgb(27,31,35)] bg-white shadow-xl rounded-xl'>
                <div className='w-full h-full flex flex-col shadow-xl'>
                    ...
                    <div className='w-full h-[112px] pl-6 py-4 flex'>          
                        ...
                        <div className='w-[672px] h-full'>
                            <button className='h-full p-3 flex items-center rounded-2xl dark:hover:bg-[#44474B] hover:bg-[#EBEBEB]'>
                                {/* User pic */}
                                ...
                                <div className='ml-1 px-2 w-[176px] h-[45px] flex flex-col'>
                                    <div className='w-full h-[25px] flex justify-between'>
                                        <span className='h-full dark:text-[rgb(255,255,255,0.6)] text-[#191919] capitalize text-[20px] font-semibold'>{name}</span>
                                    </div>
                                <div className='w-full h-[20px] text-sm dark:text-[rgb(255,255,255,0.6)] text-[#191919] flex items-center'>Post to connection only</div>
                                </div>
                            </button>
                        </div>
                        {/* cross button */}
                        <button onClick={handleCrossButton} className='w-10 h-10 flex rounded-[50%] items-center justify-center
                        dark:text-[rgba(255,255,255,0.6)] dark:hover:text-[rgba(255,255,255,0.9)] dark:hover:bg-[rgb(43,47,50)] hover:bg-[#EBEBEB] '>
                            ...
                            <div className='w-full min-h-[120px] max-h-full'>
                                <div className='w-[calc(100%-48px)] min-h-full max-h-full  mx-6 my-3 flex flex-col'>
                                    <input type='text' 
                                        placeholder='Title'
                                        value={title}
                                        className='w-full h-fit dark:bg-[rgb(27,31,35)] dark:text-[rgb(255,255,255,0.9)] dark:placeholder:text-[rgb(255,255,255,0.6)] text-[#353535] text-[24px] placeholder:text-[24px] placeholder:text-[#9E9E9E]
                                        ...
                                        className='w-full h-full dark:bg-[rgb(27,31,35)] dark:text-[rgb(255,255,255,0.9)] dark:placeholder:text-[rgb(255,255,255,0.6)] text-[#353535] text-[20px] placeholder:text-[20px] placeholder:text-[#9E9E9E]
                            ...
                            <div className='w-full h-16 py-3 pl-4 pr-6 flex justify-end border-t border-[#E8E8E8]'>
                                <div className='w-[108px] h-full flex justify-end items-center'>
                                    <div onClick={handleAddPost} className='w-16 h-8  text-base font-semibold'>
                                        <button disabled={( textArea?.length>0 && title?.length>0 ) ? false : true} 
                                        className='w-full h-full px-4 py-[6px] disabled:cursor-not-allowed disabled:bg-[#E8E8E8] dark:disabled:bg-[#373A3D]  disabled:text-[#AFAFAF] text-white
                                        dark:disabled:text-[rgb(255,255,255,0.5)] rounded-3xl bg-[#116AC3] flex justify-end items-center'>Post</button>
                                    </div>
                                </div>
                            </div>             
                        </div>
