...
// getting the first leter of UserName
  ...
  return (
    <div className='bg-white w-screen z-20 h-screen'>

      {/* header */}
      <header className='w-full h-[50px] z-20 border-b border-[#E8E8E8] flex items-center'>

        <div onClick={() => router.back()} className='w-12 h-[35px]'>
          <button className='w-full h-full p-1 flex items-center justify-center'>
            <RxCross1 className='w-6 h-6 text-[#666666]' />
          </button>
        </div>

        <div className='w-[calc(100%-35px-32px-62px-16px-4px)] h-[25px] mx-4 text-[20px] font-medium text-[#191919] flex items-center '>Share</div>
        ...
        <span className='w-[62px] h-[34px] my-2 ml-4 mr-1 flex items-center justify-center'>
          <div className='w-full h-full flex justify-end items-center'>
            <div onClick={handleAddPost} className='w-full h-full  text-base font-semibold'>
              <button disabled={( textArea?.length>0 && title?.length>0 ) ? false : true} className='w-full h-full px-4 py-[7px] border disabled:cursor-not-allowed text-sm font-semibold disabled:bg-[#E8E8E8] disabled:text-[#AFAFAF] text-white rounded-3xl bg-[#116AC3] flex justify-end items-center'>Post</button>
            </div>
          </div>
        </span>
      ...
      <div className='w-full h-fit z-20 flex flex-col'>
        ...
        <div className='w-full h-fit p-4'>
            ...
            <div className='w-full h-full py-2 flex items-center '>
              ...
              <div className='w-[calc(100%-56px)] h-[37px] flex flex-col'>
                <div className='w-full h-fit flex'>
                  <span className='h-full text-[#191919] capitalize text-sm font-medium'>{name}</span>
                </div>
                <div className='w-full h-fit text-xs text-[#666666] flex items-center'>Post to connection only</div>
              </div>
          ...
          <div className='w-full min-h-[50px] mt-2 mb-4 max-h-fit'>
            ...
            <input type='text' 
              placeholder='Title'
              value={title}
              className='w-full h-fit text-[#353535] text-base placeholder:text-base placeholder:text-[#9E9E9E]
        ...
        {/* Icon */}
        <div className='w-full h-[54px] mt-2 border-t border-[#E8E8E8] flex '>
