...
// getting the first leter of UserName
  ...
  return (
    <>
        ...
        <div className='w-full h-[250px] p-3 flex flex-col'>

            {/* header */}
            <header className='w-full h-8 mt-2 mb-1 flex items-center justify-center text-[#6E6E6E] text-[11px] capitalize tracking-wide'>
            ...
            <div className='w-full h-fit'>
                <section className='w-full h-12 mt-1 mb-2'>
                    <div className='w-full h-full text-center text-[#6E6E6E] text-sm tracking-wide'>
